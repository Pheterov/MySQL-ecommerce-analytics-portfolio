...
🎯 Goal: See how much of total revenue comes from the top 10% of products.
🛠️ Stack: SQL
💡 Impact: Shows which products drive most of the revenue, helping optimize inventory and pricing decisions.
📊 Example KPI:
